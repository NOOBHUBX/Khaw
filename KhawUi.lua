do  local uia =  game:GetService("CoreGui").RobloxGui.Modules:FindFirstChild("Khaw")  if uia then uia:Destroy() end end
...
Khaw.Name = "Khaw"
Khaw.Parent = game:GetService("CoreGui").RobloxGui.Modules
